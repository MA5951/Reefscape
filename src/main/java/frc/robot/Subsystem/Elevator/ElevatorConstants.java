...
public class ElevatorConstants {
    ...
    public static final double MAX_HIGHT = 220;
    public static final double MIN_HIGHT = 0;
    public static final double HIGHT_L2 = 100;
    public static final double HIGHT_L3 = 130;
    public static final double HIGHT_L1 = 40;
    public static final double HIGHT_L4 = 200;
    public static final double HIGHT_INTAKE_CORAL = 100;
    public static final double HIGHT_EJECT_BALL_LOW = 110;
    public static final double HIGHT_EJECT_BALL_HIGH = 140;
    public static final double HIGHT_PROSESOR = 0;
    public static final double HIGHT_ZERO = 0;

    public static final double GEAR = 7.5 / 2;
    public static final double SPROKET_PITCH_DIAMETER = 0.04;
    ...
    public static final double CAN_MOVE_CURRENT_LIMIT = 70;
    public static final double MANUEL_VOLTAGE_LIMIT = 1;
    
    public static final double ACCELERATION = 25;
    public static final double CRUSIE_VELOCITY = 100;
